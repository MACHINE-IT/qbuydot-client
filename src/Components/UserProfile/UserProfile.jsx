                            ...
                            : (
                                <>
                                    <div id="user-profile-image-container">
                                        <img
                                            src={editUserSelectedImage ? URL.createObjectURL(editUserSelectedImage) : (userSelectedImage?.includes('undefined') || !userSelectedImage ? 'avatar.png' : userSelectedImage)}
                                            alt="profile"
